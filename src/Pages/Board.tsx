...
export default function Board() {
  ...
  const handleBoardSizeChange: ChangeEventHandler<HTMLSelectElement> = (e) => {
  ...
  return (
    <MainLayout pageName="Board">
      <div className="flex flex-col items-center gap-4 mt-4">
        ...
        <BoardSizeSelector handleBoardSizeChange={handleBoardSizeChange} />
        ...
        {!lookupStatus.working && (
          <div className="p-2 mx-4">{lookupStatus.definitionString}</div>
        )}
      </div>
    </MainLayout>
  );
